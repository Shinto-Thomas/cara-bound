# CARA Randomization Plumber API
...
#* @apiTitle CARA Randomization API
#* @apiDescription API for Covariate-Adjusted Response-Adaptive Randomization in Clinical Trials
#* @apiVersion 1.0.0
...
function(patient_id, stratum) {
  ...
  if (n_current < 2 * n0) {
    ...
    if (nrow(patients_with_outcomes) < 2 * n0) {
      ...
      # Use CARA algorithm
      # Create mock potential outcomes for current patient
      # In real trial, we use historical data to estimate allocation
